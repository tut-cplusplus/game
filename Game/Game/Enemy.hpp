...
public:
	...
	Enemy(const Vector<double>& position = Vector<double>(0.0, 0.0), const Size<double>& size = Size<double>(0.0, 0.0), double speed = 0.0, double viewAngle = 45.0, double radius = 100.0, int life = 0);
	virtual ~Enemy();
